    ...
    public class Clients
    {
        public static List<Client> Get()
        {
            return new List<Client>
            {
                ...
                new Client
                {
                    ClientName = "Mailing Worker Service",
                    Enabled = true,
                    ClientId = "MailingWorkerService",
                    Flow = Flows.ClientCredentials,
                    ClientSecrets = new List<Secret>
                    {
                        new Secret("secret".Sha256()),
                ...
                new Client
                {
                    ClientName = "Just Another Implicit Client",
                    ...
                    LogoutUri = "http://localhost:9122/Home/SignoutCleanup",
                    LogoutSessionRequired = true,
                    PostLogoutRedirectUris =  { "http://localhost:9122/Home/"}
                },
